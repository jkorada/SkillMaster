...
public class SkillMasterApp {

    private static final Logger log = LoggerFactory.getLogger(SkillMasterApp.class);

    private final Environment env;

    public SkillMasterApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes SkillMaster.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(SkillMasterApp.class);
